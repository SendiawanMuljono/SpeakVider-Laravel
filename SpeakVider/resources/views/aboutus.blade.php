    ...
    <div class="row gx-0">
      ...
      <div class="col-lg-6 d-flex flex-column justify-content-center">
        <div class="content">
          ...
          <p>
          We have been established since 2021 starting from the experience of people who have difficulty finding speakers for webinar events due to the Covid-19 pandemic. The difficulty was due to differences in schedules and price compatibility. Through speakervider, this problem can be solved because we immediately display prices and schedules from the speakers.
          </p>
        </div>
      </div>
      ...
      <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
        <img src="assets/image/banner_aboutus.png" class="img-fluid" id="gambarabout" alt="">
      </div>
